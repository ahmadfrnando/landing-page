...
const Hero = () => {
  return (
    <div className='max-w-screen md:mt-0 mt-14 dark:bg-gray-900 '>
        <div className='container py-8 md:py-4 md:px-8 px-8 md:grid md:grid-cols-2 gap-10'>
